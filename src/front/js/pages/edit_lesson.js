...
export const Edit_Lesson = () => {
  ...
  const [keyword1, setKeyword1] = useState(
    dataLesson ? dataLesson["key_word1"] : null
  );
  const [keyword2, setKeyword2] = useState(
    dataLesson ? dataLesson["key_word2"] : null
  );
  const [keyword3, setKeyword3] = useState(
    dataLesson ? dataLesson["key_word3"] : null
  );
  const [question1, setQuestion1] = useState(
    dataLesson ? dataLesson["question1"] : null
  );
  const [question2, setQuestion2] = useState(
    dataLesson ? dataLesson["question2"] : null
  );
  const [question3, setQuestion3] = useState(
    dataLesson ? dataLesson["question3"] : null
  );
  const [question4, setQuestion4] = useState(
    dataLesson ? dataLesson["question4"] : null
  );
  const [nameteacher, setNameteacher] = useState(
    dataLesson ? dataLesson["id"] : null
  );
      ...
      <form className="container-fluid">
        <div className="form-row d-flex container-fluid col-10 gap-4 flex-wrap my-4">
          <div className="form-group col">
            ...
            <input
              ...
              // placeholder={}
              value={
                disabled ? (dataLesson ? dataLesson["subject"] : null) : subject
              }
          ...
          <div className="form-group col">
            ...
            <input
              ...
              value={
                disabled ? (dataLesson ? dataLesson["title"] : null) : title
              }
        ...
        <div className="form-group mx-auto col-10 my-4">
          ...
          <textarea
            ...
            value={
              disabled ? (dataLesson ? dataLesson["summary"] : null) : summary
            }
