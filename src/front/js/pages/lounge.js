...
export const Lounge = () => {
  ...
  const listOfTeachers = store?.teachers?.[0]?.teachers.map(
    (teacher, indexT) => {
      return (
        <div key={indexT}>
          <Link to="/teacherpage" className="link-dark">
            <div className="text-center">
              <div
                onClick={() => {
                  let saveTeacherId = teacher.id;
                  console.log(saveTeacherId);
                  actions.onClickSaveTeacherId(teacher.id);
                }}
              >
                <Card
  ...
  return (
    <div className="container">
      ...
      <div className="container-fluid">
        <h2 className="container-fluid col-10 fst-italic pt-5">
      ...
      <div className="container-fluid">
        <h2 className="container-fluid col-10 fst-italic pt-5 border-top">
