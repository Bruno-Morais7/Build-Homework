...
export const Edit_Profile = () => {
  ...
  useEffect(() => {
    if (userLoggedisteacher === true) {
      ...
      const dataLoggedStudent = store?.student?.[0]?.students.find(
        (e) => e.email === userLoggedEmail
      );
  ...
  const [subjects1, setSubjects1] = useState(
    alluserdetails ? alluserdetails.subjects1 : null
  );
  const [subjects2, setSubjects2] = useState(
    alluserdetails ? alluserdetails.subjects2 : null
  );
  const [subjects3, setSubjects3] = useState(
    alluserdetails ? alluserdetails.subjects3 : null
  );
  const [subjects4, setSubjects4] = useState(
    alluserdetails ? alluserdetails.subjects4 : null
  );
      ...
      <div className="col-xl-6 col-md-8 mx-auto border rounded-3 bg-dark text-white">
        <div className="flex-wrap">
          <div className="p-5">
            ...
            />
            <button
              className="btn btn-warning mb-5 me-5 btn-sm"
            ...
            <div>
              ...
              <input
                ...
                value={
                  disabled
                    ? alluserdetails
                      ? alluserdetails.years_experience
                      : null
                    : yearsexperience
                }
        ...
        <div className="col-md-12 text-end">
          ...
          <button className="btn btn-warning mb-5 me-5" onClick={submitTeacher}>
            Update
          </button>
        </div>
      </div>
      <h5 className="container-fluid col-8 fst-italic mt-4 mb-5 d-flex">
        For security reasons with Teach & Learn users, if you are interested in
        changing your photo or email, write to us.
      </h5>
    </div>
  );
};
