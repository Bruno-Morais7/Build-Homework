export const baseUrl =
  "https://3001-brunomorais-teachandlea-v4s2lt4a3od.ws-eu47.gitpod.io";
      ...
      postLessonsData: () => {
        ...
        fetch(baseUrl + "/api/lessons", {
          ...
          body: JSON.stringify({
            ...
            introduction: document.getElementById("lessonContent_introduction")
              .value,
            written_content: document.getElementById("lessonContent_mainpart")
              .value,
